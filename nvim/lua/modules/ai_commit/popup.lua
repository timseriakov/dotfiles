...
function M.open_commit_popup(initial_text, commit_file, git_root, opts)
  ...
  local total_height = commit_height + diff_height + 1
  ...
  vim.api.nvim_create_autocmd("BufWriteCmd", {
    ...
    callback = function()
      ...
      local args = { "git", "commit", "-F", commit_file }
      if opts and opts.amend then
