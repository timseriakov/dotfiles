...
- Keep `mem_session_summary` compact: durable outcomes, decisions, risks, next steps, and relevant files only; do not paste raw tool logs or repeat the full Memory Bank.
- Prefer one summary per compaction/session boundary; use `mem_save` for individual decisions and fixes.
