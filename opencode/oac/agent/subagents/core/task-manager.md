    ...
    <stage id="0" name="ContextLoading">
      ...
      <process>
        1. Load task management context:
           - `/Users/tim/.config/opencode/context/core/task-management/navigation.md`
           - `/Users/tim/.config/opencode/context/core/task-management/standards/task-schema.md`
           - `/Users/tim/.config/opencode/context/core/task-management/guides/splitting-tasks.md`
           - `/Users/tim/.config/opencode/context/core/task-management/guides/managing-tasks.md`
          ...
          3. Create subtask_NN.json for each task:
              ...
              **LINE-NUMBER PRECISION** (Enhanced Schema):
              ...
              "context_files": [
                ...
                {
                  "path": "/Users/tim/.config/opencode/context/core/standards/security-patterns.md",
