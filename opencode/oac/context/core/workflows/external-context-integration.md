...
- Answer is in `/Users/tim/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/tim/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/tim/.config/opencode/context/core/workflows/task-delegation-basics.md`
