...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/Users/tim/.config/opencode/context/`) so they're project-specific and git-committed.
...
Local location: /Users/tim/.config/opencode/context/
...
If local `/Users/tim/.config/opencode/context/project-intelligence/` already exists:
...
Will copy to:   /Users/tim/.config/opencode/context/project-intelligence/
...
Copied 3 files to /Users/tim/.config/opencode/context/project-intelligence/
...
- Context path resolution: `/Users/tim/.config/opencode/context/core/system/context-paths.md`
