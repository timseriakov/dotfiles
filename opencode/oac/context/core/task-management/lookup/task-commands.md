...
```bash
npx ts-node /Users/tim/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/tim/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
