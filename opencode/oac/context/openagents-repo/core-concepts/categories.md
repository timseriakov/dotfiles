...
/Users/tim/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/tim/.config/opencode/context/{category}
...
```bash
cat > /Users/tim/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/tim/.config/opencode/context/{category}/
...
Loads: `/Users/tim/.config/opencode/context/ui/web/react-patterns.md`
