...
/**
 * Plannotator Release Watcher
 *
 * Polls GitHub releases for backnotprop/plannotator,
...
const CONFIG = {
  ...
  stateFile: "plannotator_last_tag.txt",
...
async function main() {
  ...
  console.log("[START] Plannotator Release Watcher");
