...
/**
 * opencode Release Watcher
 *
 * Polls GitHub releases for anomalyco/opencode,
...
const CONFIG = {
  ...
  stateFile: "opencode_last_tag.txt",
...
async function fetchGitHub(path) {
  ...
  const options = {
    headers: {
      "User-Agent": "opencode-release-watcher/1.0",
...
async function main() {
  ...
  console.log("[START] opencode Release Watcher");
