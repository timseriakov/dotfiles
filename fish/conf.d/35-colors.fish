...
set -g fish_pager_color_description $nord4 # slightly lighter descriptions
set -g fish_pager_color_progress "$nord6 --background=$nord2"
...
set -g fish_pager_color_selected_description $nord4
